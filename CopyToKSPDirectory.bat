...
xcopy /Y ".\Client\bin\Debug\LunaClient.*" "%KSPPATH%\GameData\LunaMultiPlayer\Plugins"

".\External\pdb2mdb\pdb2mdb.exe" ".\Common\bin\Debug\LunaCommon.dll"
xcopy /Y ".\Common\bin\Debug\LunaCommon.*" "%KSPPATH%\GameData\LunaMultiPlayer\Plugins"

xcopy /Y ".\External\Dependencies\*.dll" "%KSPPATH%\GameData\LunaMultiPlayer\Plugins"
