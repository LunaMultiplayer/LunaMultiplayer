...
namespace LunaClient.Systems.CraftLibrary
{
        ...
        MessageSystem<CraftLibrarySystem, CraftLibraryMessageSender, CraftLibraryMessageHandler>
    {
        ...
        //Public
        public ConcurrentQueue<CraftChangeEntry> CraftAddQueue { get; } = new ConcurrentQueue<CraftChangeEntry>();
        public ConcurrentQueue<CraftChangeEntry> CraftDeleteQueue { get; } = new ConcurrentQueue<CraftChangeEntry>();
        public ConcurrentQueue<CraftResponseEntry> CraftResponseQueue { get; } = new ConcurrentQueue<CraftResponseEntry>();
        ...
        private static string SavePath { get; } = CommonUtil.CombinePaths(KSPUtil.ApplicationRootPath, "saves", "LunaMultiPlayer");
