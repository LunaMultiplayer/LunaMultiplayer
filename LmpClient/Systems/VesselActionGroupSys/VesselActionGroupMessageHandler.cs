...
namespace LmpClient.Systems.VesselActionGroupSys
{
    public class VesselActionGroupMessageHandler : SubSystem<VesselActionGroupSystem>, IMessageHandler
    {
        ...
        {
            LunaLog.Debug($"Current memory usage for stored messages in the VesselActionGroup system: {Math.Floor(StoredMessagesData.Count * sizeof(VesselActionGroupMsgData) / 1024)}KB");
        }
    }
}
