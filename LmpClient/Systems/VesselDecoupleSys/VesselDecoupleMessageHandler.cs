...
namespace LmpClient.Systems.VesselDecoupleSys
{
    public class VesselDecoupleMessageHandler : SubSystem<VesselDecoupleSystem>, IMessageHandler
    {
        ...
        public SortedList<double,VesselDecoupleMsgData> StoredMessagesData { get; set; } = new SortedList<double,VesselDecoupleMsgData>();
        ...
        public void LogQueuedMessagesSize()
        {
            ...
            LunaLog.Log($"Current memory usage for stored messages in the VesselDecouple system: {memUsage}KB");
        }
    }
}
