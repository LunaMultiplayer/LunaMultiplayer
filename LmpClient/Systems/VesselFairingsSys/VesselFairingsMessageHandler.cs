...
namespace LmpClient.Systems.VesselFairingsSys
{
    public class VesselFairingsMessageHandler : SubSystem<VesselFairingsSystem>, IMessageHandler
    {
        ...
        public void TryQueueUpdate(VesselFairingMsgData msgData)
        {
        ...
        {
            LunaLog.Debug($"Current memory usage for stored messages in the VesselFairings system: {Math.Floor(StoredMessagesData.Count * sizeof(VesselFaringMsgData) / 1024)}KB");
        }
    }
}
