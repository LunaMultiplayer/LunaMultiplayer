...
namespace LmpClient.Systems.VesselPartSyncCallSys
{
    public class VesselPartSyncCallMessageHandler : SubSystem<VesselPartSyncCallSystem>, IMessageHandler
    {
        ...
        public SortedList<double,VesselPartSyncCallMsgData> StoredMessagesData { get; set; } = new SortedList<double,VesselPartSyncCallMsgData>();
        ...
        public void LogQueuedMessagesSize()
        {
            ...
            LunaLog.Log($"Current memory usage for stored messages in the VesselPartSyncCall system: {memUsage}KB");
        }
    }
}
