...
namespace LmpClient.Systems.VesselPartSyncUiFieldSys
{
    public class VesselPartSyncUiFieldMessageHandler : SubSystem<VesselPartSyncUiFieldSystem>, IMessageHandler
    {
        ...
        public SortedList<double,VesselPartSyncUiFieldMsgData> StoredMessagesData { get; set; } = new SortedList<double,VesselPartSyncUiFieldMsgData>();
        ...
        public void LogQueuedMessagesSize()
        {
            ...
            LunaLog.Log($"Current memory usage for stored messages in the VesselPartSyncUiField system: {memUsage}KB");
        }
#endif
    }
}
