...
namespace LmpClient.Systems.VesselPartSyncUiFieldSys
{
    public class VesselPartSyncUiFieldMessageHandler : SubSystem<VesselPartSyncUiFieldSystem>, IMessageHandler
    {
        ...
        public ConcurrentQueue<VesselPartSyncUiFieldMsgData> StoredMessagesData { get; set; } = new ConcurrentQueue<VesselPartSyncUiFieldMsgData>();
        ...
        public void TryQueueUpdate(VesselPartSyncUiFieldMsgData msgData)
        {
        ...
        {
            LunaLog.Debug($"Current memory usage for stored messages in the VesselPartSyncUiField system: {Math.Floor(StoredMessagesData.Count * sizeof(VesselPartSyncUiFieldMsgData) / 1024)}KB");
        }
    }
}
