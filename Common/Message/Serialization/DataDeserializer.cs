...
namespace LunaCommon.Message.Serialization
{
    ...
    public static partial class DataDeserializer
    {
            ...
            <Type, Func<Stream, object>>
        {
            ...
            [typeof(FlagInfo)] = messageData => GetFlagInfoFromBytes(messageData),
            ...
            [typeof(FlagInfo[])] = messageData => GetFlagInfoArrayFromBytes(messageData),
        ...
        private static void DeserializeProperty(Stream messageData, object dataClass, ReducedPropertyInfo prop, TypeAccessor accessor)
        {
            try
            {
                ...
                {
                    if (!Equals(value, accessor[dataClass, prop.Name]))
